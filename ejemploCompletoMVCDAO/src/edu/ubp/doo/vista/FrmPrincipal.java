 ...
 * @author agustin
 */
public class FrmPrincipal extends javax.swing.JFrame implements InterfazVistaPrincipal {
    ...
    private void initComponents() {
        ...
        mItemAlumnos.setActionCommand("ABMALUMNO");
        ...
        mItemInscripciones.setActionCommand("ABMINSCRIPCION");
    ...
    public void setControlador(Controlador c) {
        for (int i = 0; i < jMenuBar1.getMenuCount(); i++) {
            JMenu menu1 = jMenuBar1.getMenu(i);
